...
module.exports.run = async (client, message, args) => {
    ...
    .setURL(`${gameUrl}`)
    .setColor('RANDOM')
    .setDescription(`Hello people! The server is open! Come & join the server. Make some good roleplays! This Server Start Up is run by ${message.author}! Press "DDC | Start up!" so you can enter the game!`);
